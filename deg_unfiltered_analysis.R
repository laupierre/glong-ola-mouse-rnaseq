...
write.xlsx (res, paste (paste ("GLONG_vs_OLA_2023_" , age[i], sep=""), "_months.xlsx", sep=""), rowNames=F)
...
pdf (paste (paste ("Heatmap plot", age[i], sep=" "), "months.pdf", sep=" "))
...
ggsave (paste (paste ("PCA plot", age[i], sep=" "), "months.pdf", sep=" "))
...
pdf (paste ("Distance between samples plot", paste (age[i], "months.pdf"), sep=" "))
